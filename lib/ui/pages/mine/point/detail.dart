...
class _PointDetailPageState extends State<PointDetailPage> {
  ...
  Widget build(BuildContext context) {
    ...
    var  ruleTitle=S.of(context).useRule;
    var goodsDetailTitle=S.of(context).goodsDetail;
    var submit=S.of(context).changePoint;
              ...
              child:Column(
                  children: <Widget>[
                                ...
                                children: <Widget>[
                                  ...
                                  Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: <Widget>[
                                        Text('1880'+S.of(context).point,style: TextStyle(color: Color(0xffFF0000),fontSize: 34.rpx),overflow: TextOverflow.ellipsis,),
                    ...
                    ThemeButton(
                        title: submit,
                        onPressed:(){
                             Navigator.of(context).pushNamed(RouteName.createAnPointOrder,arguments: ['id']);
                        }
                    )
                  ],
                ),
